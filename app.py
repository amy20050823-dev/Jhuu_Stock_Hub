...
STOCK_DB = {
    ...
    "記憶體與模組": {"2408": "南亞科", "2344": "華邦電", "8299": "群聯", "3260": "威剛", "2451": "創見", "8281": "美光", "4967": "十銓"}, # 注意: 台股沒有美光代號，這裡以概念股為主
    "被動元件": {"2327": "國巨", "2492": "華新科", "3026": "禾伸堂", "6127": "九暘", "2456": "奇力新(下市改為大毅)": "2478", "2478": "大毅"},
    ...
    for symbol, name in stock_dict.items():
        try:
            ...
            data_list.append({
                ...
                "現價": round(close, 2), 
                "波段策略": display_action,  # 顯示帶有括號的複合標籤
                "策略權重": action_prio,     # 排序依然依照主策略權重
